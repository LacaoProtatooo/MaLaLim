      ...
      <div class="rounded-3xl bg-white shadow-lg">
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          ...
          <div class="mt-6 text-center">
            <button id = "checkoutButt" type="button" onclick="window.location.href='{{ route('checkout') }}'" class="group inline-flex w-full items-center justify-center rounded-md bg-yellow-300 px-6 py-4 text-lg font-semibold CheckCheck">
                Place Order
            </button>
          </div>
        </div>
