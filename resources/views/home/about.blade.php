...
<div class="card lg:card-side rounded-md mt-11 mr-4 ml-4 bg-gradient-to-r from-gray-100 via-yellow-300 to-gray-100">
<figure>
    <img class="p-10 border-r-pink-900" src="../storage/jewelryabt.png" alt="Album"/>
</figure>
  <div class="card-body rounded">
  <section class="">
        <div class="py-12 bg-gradient-to-r from-white to-transparent rounded-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center">
                    ...
                    <p class="mt-4 max-w-2xl text-lg text-gray-900 lg:mx-auto text-justify">
                    ...
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-900">Made with Care</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-900 text-justify">
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-900">Looks expensive, but affordable</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-900 text-justify">
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-900">Wide Selections</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-900 text-justify">
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-900">Shipping anytime, anywhere</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-900 text-justify">
