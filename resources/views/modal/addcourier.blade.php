...
<dialog id="createcouriermodal" class="modal">
    <div class="modal-box">
        <div class="relative bg-white rounded-lg">
            <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onclick="document.getElementById('createcouriermodal').close()">✕</button>
            <h3 class="text-lg font-bold mb-4"> Create New Courier </h3>
        
            <form class="max-w-md mx-auto" id="courierForm" method="#" action="#" enctype="multipart/form-data">
                @csrf
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="email" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Courier Name</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
