...
<dialog id="registeruserModal" class="modal">
    <div class="modal-box">
        <div class="relative bg-white rounded-lg">
            ...
            <form class="max-w-md mx-auto" id="userregisterForm" method="#" action="#" enctype="multipart/form-data">        
                {{-- email --}}
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    {{-- Birthdate --}}
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="date" name="birthdate" id="birthdateedit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
