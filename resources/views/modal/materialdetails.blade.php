<dialog id="editmaterialmodal" class="modal">
    <div class="modal-box">
        <div class="relative bg-white rounded-lg">
            <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onclick="document.getElementById('editmaterialmodal').close()">✕</button>
            <h3 class="text-lg font-bold mb-4"> Jewelry Details </h3>

            <form class="max-w-md mx-auto" id="materialeditform" method="PUT" action="#" enctype="multipart/form-data">
                <input id="materialId" type="hidden" name="matid" value="">
