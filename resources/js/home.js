        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.data.forEach(jewel => {
                    ...
                    const jewelHTML = `
                        <div class="col-span-1 bg-grey-100 mx-2">
                            <div class="group my-4 flex w-full max-w-md flex-col overflow-hidden border border-gray-100 bg-white shadow-md rounded-lg">
                                ...
                                <div class="mt-2 px-6 pb-2">
                                    ...
                                    <div class="grid grid-cols-4 gap-2">
                                        ...
                                        <button class="add2Fave col-span-1 items-center justify-center px-4 py-2 text-lg border-black text-black bg-gray-100 transition hover:bg-red-400 hover:text-black rounded-md" data-id="${jewel.id}">
